...
export function afficherListeMessage(){
        const item= createElement('div',{},[
                                                                                ...
                                                                                createElement('div', {class: "w-[20vw] h-[10vh] flex flex-col  "},
                                                                                                    [ 
                                                                                                        createElement('div', {class: "w-[20vw] h-[5vh] flex items-end"}, [
                                                                                                                    createElement('p', {class: "ml-2 font-semibold text-white"}, "Khadidiatou Fall")
                                                                                                        ]),
