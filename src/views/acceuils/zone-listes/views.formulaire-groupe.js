...
export function afficherformulaireGroupe(){
        const formulaire = createElement('form', {
                                                                          ...
                                                                          createElement('div', {class: "flex flex-col gap-6"}, [
                                                                                            ...
                                                                                            createElement('div', {class:"flex items-center bg-white w-[23vw] h-[6vh] border border-[#039393] rounded-[20px] px-4 py-4 hover:bg-[#235347]/30 focus-within:bg-[#235347]/30  transition duration-300 transform hover:scale-110"}, [
                                                                                                        createElement('div', {class:"bg-[#202c33] backdrop-blur-sm  rounded-full p-2 mr-4 "}, [
                                                                                                                    createElement('i', {class:"fas fa-users w-5 h-5 text-black text-center", }),
                                                                                                        ]),
                                                                                                        createElement('input', {class: "bg-transparent text-black placeholder-black-200 w-full  focus:outline-none ", id:"nomG", placeholder:"Nom du groupe", type:"text" , }, ),
                                                                                                        
                                                                                                  ]),
                                                                                            createElement('small', {id: 'erreur-prenom', class: "hidden text-[1rem] text-red-500 mt-[1.5rem] ml-[1rem]"}, ),
                                                                                            ]),
                                                                                            
                                                                                            createElement("button", {class:"w-[23vw] p-3  ml-[2.5vw] rounded-[20px] bg-[#039393] text-black font-semibold text-lg shadow-lg hover:from-[#fb6123] hover:to-[#fb6123] hover:shadow-xl hover:-translate-y-1 transition-all duration-300", type:"submit",}, 'Ajouter'),
